...
def train_tcn_xgboost_hybrid(
    ...
    OPTIMAL_HYPERPARAMS = {
        ...
        "tcn_params": {
            ...
            "nb_filters": 120,  # Dikurangi dari 120 → 32
            "kernel_size": 4,  # Dikurangi dari 4 → 3
            "nb_stacks": 3,  # Dikurangi untuk simplify
            "dilations": [1, 2, 4],  # Short dilations untuk weekly patterns
            # Regularization (Aggressive)
            "dropout_rate": 0.25,  # Dinaikkan dari 0.25 → 0.4
            "spatial_dropout": 0.2,  # Tambahan regularization
            "kernel_regularizer": "l2",
            "kernel_regularizer_strength": 1e-4,
            # Training (Conservative)
            "learning_rate": 2.5e-4,  # Dikurangi dari 2.5e-4
            "optimizer": "adamw",
            "weight_decay": 1e-3,
        ...
        "xgb_params": {
            ...
            "eval_metric": "rmse",
            "n_estimators": 1000,
            "learning_rate": 0.0807285466012292,
            "max_depth": 3,
            "subsample": 0.9878363373252806,
            "colsample_bytree": 0.9186379028208741,
            "reg_alpha": 0.18459690345484073,
            "reg_lambda": 8.70524808585881,
            "random_state": 42,
            "n_jobs": -1,
        },
        "training_params": {
...
if __name__ == "__main__":
    ...
    intermediate_data_folder = os.path.join(
        base_folder_path, "1. Normalisasi", "Data", "Data_Rekayasa2"
    )
    final_output_folder = os.path.join(
        base_folder_path, "2. Hasil Normalisasi", "Terbaru2"
    )
    models_folder = os.path.join(base_folder_path, "5. Model", "models_terbaru2")
